            ...
            <thead className="bg-secondary/50">
              <tr>
                {[
                  ...
                  <th
                    key={h}
                    className={`py-3 px-4 text-xs font-semibold text-muted-foreground uppercase ${i === 0 || i === 5 ? "" : "text-right"}`}
                  >
                    {h}
                  </th>
                ))}
              ...
              {positions.map((pos) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className={`py-3.5 px-4 text-right font-mono font-semibold ${isProfit ? "text-success" : "text-danger"}`}
                    >
