...
export default function Settings() {
  ...
  const [apiKey, setApiKey] = useState(
    () => localStorage.getItem("quantforge_api_key") || generateApiKey(),
  );
  ...
  return (
    <div className="min-h-full bg-background p-4 md:p-6 lg:p-8 relative">
      ...
      {toast && (
        <div
          className={`fixed top-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-xl shadow-xl border text-sm font-medium transition-all duration-300 ${
            toast.type === "success"
      ...
      <div className="mb-6 flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure preferences for <strong>{user?.username}</strong>
          </p>
        </div>
      </div>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <Widget title="Display Preferences" menuItems={commonMenuItems}>
          <div className="space-y-4">
            <SettingRow
              label="Dark Mode"
              description="Enable the dark trading terminal theme"
            >
              <Switch
            ...
            <div className="border-t border-border/50 pt-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  {
                    id: "dark",
                    icon: <Moon className="w-5 h-5 mx-auto mb-2" />,
                    label: "Dark",
                  },
                  {
                    id: "light",
                    icon: <Sun className="w-5 h-5 mx-auto mb-2" />,
                    label: "Light",
                  },
                  {
                    id: "auto",
        ...
        <Widget title="Notifications" menuItems={commonMenuItems}>
          <div className="space-y-3">
            <SettingRow
              ...
              description="Browser push alerts for signals"
            >
              <Switch
            ...
            <SettingRow
              label="Email Alerts"
              description="Get signals via email"
            >
              <Switch
            ...
            <SettingRow
              label="Sound Alerts"
              description="Play sound on new signal"
            >
              <Switch
        ...
        <Widget title="Trading Configuration" menuItems={commonMenuItems}>
          <div className="space-y-4">
            ...
            {[
              ...
              <div key={field.key}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateSetting(field.key, parseFloat(e.target.value))
                  }
            ...
            <SettingRow
              label="Auto-Close Losing Positions"
              description="Automatically cut losses at stop-loss"
            >
              <Switch
                checked={settings.autoClose}
                onCheckedChange={(v) => updateSetting("autoClose", v)}
              />
            </SettingRow>
          </div>
        </Widget>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Keep your API key secret. Regenerating invalidates the old key.
              </p>
            </div>
              ...
              {showResetConfirm ? (
                <div className="p-4 bg-danger/5 border border-danger/30 rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground mb-3">
                    This will clear all local data and log you out. Your account
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 py-2 bg-danger text-white rounded-lg text-xs font-semibold hover:bg-danger/90"
                    >
                      Confirm Reset
                    </button>
                  </div>
        ...
        <div className="p-4 bg-primary/5 border border-primary/30 rounded-lg">
          <p className="text-sm text-foreground">
            <span className="font-semibold">Pro Tip:</span> Settings are saved
            to your browser. Click "Save Settings" to persist across sessions.
          </p>
        </div>
      </div>
    </div>
